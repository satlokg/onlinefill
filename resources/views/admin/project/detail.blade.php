          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="tab_1">
                @php
                  $tasks = $project->tasks()->posts->sortByDesc('created_at')->paginate(2);
                @endphp
        ...
        <div class="col-md-5">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="#tab_1-1" data-toggle="tab">Assigned User</a></li>
              <li class="pull-left header"><i class="fa fa-th"></i>Feedback</li>
            </ul>
            <div class="tab-content">
              <div class="tab-pane active bg-aqua" style="padding:5px; color: #000" id="tab_1-1">
               <ul class="list-group">
