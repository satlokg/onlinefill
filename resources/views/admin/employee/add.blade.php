                      ...
                      <div class="box-body">
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="technology" type="text" class="form-control @error('technology') is-invalid @enderror" name="technology" value="{{ old('technology') }}" required autocomplete="technology">
