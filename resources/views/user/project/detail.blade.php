          ...
          <div class="box">
            <div class="box-header with-border">
             ...
             <div class="pull-right">
                @if($at && $at->status==1 && $at->project_id==$project->id)
                <a href="{{route('user.project.stop',['ids'=>encrypt($at->id)])}}" class="btn btn-sm btn-danger pull-right">Stop Project</a>
                @else
                <a href="{{route('user.project.start',['key'=>encrypt($project->id)])}}" class="btn btn-sm btn-info pull-right">Start Project</a>
                @endif
                ...
                @endif 
                    <div class="box-header with-border">
                      ...
                      <div class="box-tools pull-right">
                        ...
                        @if($task->user->id == Auth::user()->id && $task->created_at->format('Y-m-d') == \Carbon\Carbon::now()->format('Y-m-d'))
